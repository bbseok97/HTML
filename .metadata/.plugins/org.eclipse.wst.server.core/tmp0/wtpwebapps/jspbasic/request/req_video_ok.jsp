...
<html>
	...
	<% 	}else if(sel == 1){ %>
		...
		<%}else if(sel == 2) { %>
		<div align="center">
			<h2>자바 수업을 리뉴얼 했습니다.</h2>
			<p>나도코딩 자바 수업...</p>
			<hr>
			<iframe width="640" height="480" src="https://www.youtube.com/embed/NQq0dOoEPUM" title="자바 코딩 무료 강의 (기본편) - 9시간 뒤면 여러분도 개발자가 될 수 있어요" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
		</div>
		<%} %>
